...
def get_model(with_downstream_arch=True):
    ...
    if with_downstream_arch:
        ...
        downstream_architecture = downstream_architectures.GDINOObjectDetectionDownstreamArch(
            crop_to_scene_size_ratio=0.2,
            ...
            use_loc_to_select_bbs=True,
            use_any_fine_loc_to_select_bbs=True,
        )
    else:
